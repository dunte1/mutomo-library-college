@php
    $primary = $cardBranding['card_primary_color'] ?? '#0B3C6D';
    $secondary = $cardBranding['card_secondary_color'] ?? '#0D47A1';
    $tertiary = $cardBranding['card_tertiary_color'] ?? '#0097A7';
    $textColor = $cardBranding['card_text_color'] ?? '#0a1e3a';
    $accentColor = $cardBranding['card_accent_color'] ?? '#FFC107';
