    ...
    <div class="card p-4">
        <form wire:submit="search" class="flex flex-col sm:flex-row gap-3">
            ...
            <div class="sm:self-end">
                <button type="submit" class="btn-primary w-full sm:w-auto inline-flex items-center justify-center gap-2" wire:loading.attr="disabled" wire:loading.class="opacity-60">
