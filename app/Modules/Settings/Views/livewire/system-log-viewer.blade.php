...
<div>
    ...
    <x-slot name="subtitle">View activity log entries recorded by the system</x-slot>
    ...
    @can('clear-audit-logs')
        <div class="mb-4 flex justify-end">
            <button wire:click="clearLogs" wire:confirm="Are you sure you want to clear all system logs? This action cannot be undone."
