                    ...
                    @if($results)
                        @if(count($results['books']))
                            ...
                            @foreach($results['books'] as $item)
                                <a href="{{ $item['url'] }}" wire:navigate wire:click="close"
                        ...
                        @php $totalResults = collect($results)->flatten(1)->count(); @endphp
                        @if(!$totalResults && strlen($this->query) >= 2)
