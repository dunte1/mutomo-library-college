...
Route::middleware(['auth', 'verified'])->prefix('circulation')->name('circulation.')->group(function () {
    ...
    Route::get('/issue', IssueBook::class)->name('issue')->middleware(['permission:borrow-books', 'subscription:borrow']);
    Route::get('/return', ReturnBook::class)->name('return')->middleware(['permission:return-books', 'subscription:borrow']);
    ...
    Route::get('/my-reservations', PatronReservation::class)->name('my-reservations');
});
