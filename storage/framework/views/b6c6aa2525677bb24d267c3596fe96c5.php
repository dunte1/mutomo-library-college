    ...
    <div x-show="mobileMenuOpen"
        ...
        <div x-show="mobileMenuOpen"
            ...
            <div class="flex items-center justify-between h-16 px-4 border-b border-primary-700/50 shrink-0">
                <a href="<?php echo e(route('dashboard')); ?>" wire:navigate @click="mobileMenuOpen = false" class="flex items-center gap-3">
                    ...
                    <span class="text-sm font-bold text-white"><?php echo e(config('app.name')); ?></span>
                </a>
            ...
            <nav class="flex-1 overflow-y-auto scrollbar-thin p-3 space-y-1" aria-label="Mobile navigation links">
                <?php echo $__env->make('components.layout.nav-items', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </nav>
...
<?php /**PATH C:\Users\Lab IX\Documents\proj\ollmchs-library\resources\views/components/layout/mobile-drawer.blade.php ENDPATH**/ ?>