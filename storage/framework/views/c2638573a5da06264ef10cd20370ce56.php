...
<body class="font-sans antialiased bg-surface-50">
    <div class="flex min-h-screen">
        ...
        <div class="hidden lg:flex lg:w-[55%] relative bg-gradient-to-br from-primary-900 via-primary-800 to-primary-700 items-center justify-center p-12 overflow-hidden">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($carouselImages && $carouselImages->isNotEmpty()): ?>
                <div x-data="{
                    current: 0,
                    images: <?php echo \Illuminate\Support\Js::from($carouselImages->map(fn($i) => ['image_path' => $i->image_path, 'title' => $i->title, 'subtitle' => $i->subtitle]))->toHtml() ?>,
                    init() {
            ...
            <div class="relative max-w-lg text-center z-10">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$carouselImages || $carouselImages->isEmpty()): ?>
