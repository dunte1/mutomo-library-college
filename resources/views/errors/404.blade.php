<x-guest-layout>
    <div class="min-h-screen flex items-center justify-center px-4">
        <div class="max-w-md w-full text-center">
            ...
            <h1 class="text-6xl font-bold text-surface-900 dark:text-white mb-4">404</h1>
            <h2 class="text-xl font-semibold text-surface-700 dark:text-surface-300 mb-2">Page Not Found</h2>
            <p class="text-surface-500 dark:text-surface-400 mb-8">The page you're looking for doesn't exist or has been moved.</p>
