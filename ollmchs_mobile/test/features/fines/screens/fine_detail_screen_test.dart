  ...
  Widget buildScreen() {
    return MaterialApp(
      home: BlocProvider<FinesBloc>(
        ...
        child: const FineDetailScreen(fineId: 1),
      ),
    );
  }

  group('FineDetailScreen', () {
    testWidgets('renders without crashing', (tester) async {
      await tester.pumpWidget(buildScreen());
      await tester.pumpAndSettle();
      expect(find.byType(FineDetailScreen), findsOneWidget);
    });

    testWidgets('shows fine details from API', (tester) async {
      await tester.pumpWidget(buildScreen());
      await tester.pumpAndSettle();
