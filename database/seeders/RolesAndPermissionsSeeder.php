    ...
    public function run(): void
    {
        ...
        $roles = [
            ...
            'librarian' => Permission::whereIn('name', [
                ...
                'view-financial-reports',
                'send-notifications', 'view-notification-logs',
                'view-reports', 'generate-reports', 'export-reports',
                'manage-announcements', 'manage-events',
                'send-messages', 'view-messages', 'reply-messages',
                'reply-all-messages', 'forward-messages',
                'manage-broadcasts', 'view-message-logs',
                'manage-templates',
                'manage-scheduled-messages',
                'view-communication-analytics',
